...
/**
 * swap_node_behind - Swap a node in a listint_t type doubly-linked
 * list of integers with the node behind it.
 * @list: A pointer to the head of a dll.
 * @tail: A pointer to the tail of the dll.
 * @shaker: A pointer to the current swapping node of the cocktail
 * shaker algorithm.
 */
void swap_node_behind(listint_t **list, listint_t **tail, listint_t **shaker)
...
/**
 * cocktail_sort_list - Sort a listint_t doubly-linked list in
 * ascending order using the cocktail shaker algorithm.
 * @list: A pointer to the head of a listint_t type doubly-linked list.
 */
void cocktail_sort_list(listint_t **list)
{
